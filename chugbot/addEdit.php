...
class Column
{
    public function __construct($name, $required = true, $defaultValue = null)
    {
        $this->name = $name;
...
{
    public function __construct($title, $firstParagraph)
    {
        $this->title = $title;
...
{
    public function __construct($title, $firstParagraph, $mainTable, $idCol)
    {
